...
function onStartup(self, msg)
    GAMEOBJ:GetTimer():AddTimerWithCancel( 13, "BossFlashes", self ) 
    --GAMEOBJ:GetTimer():AddTimerWithCancel( 18, "LittleFlashes", self ) 
GAMEOBJ:GetTimer():AddTimerWithCancel( 4, "PortalCloseFlash", self )    
    GAMEOBJ:GetTimer():AddTimerWithCancel( 2.5, "StartBigFlash", self ) 
end
...
function onTimerDone(self, msg)
    ...
    if (msg.name == "BossFlashes") then
        UI:SendMessage("BossBattleFlash1", {})
    end
