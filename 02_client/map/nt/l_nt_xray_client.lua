...
-- updated abeechler ... 9/13/11 - filter out undesirable player touches to prevent cinematic disrutption
...
function onCollisionPhantom(self, msg)
	...
	if(player:GetID() ~= GAMEOBJ:GetControlledID():GetID()) then return end
