...
function onCollisionPhantom(self, msg)
	...
	if vehicle:GetID() == GAMEOBJ:GetControlledID():GetID() then
		...
		local massMultiplier = vehicle:GetMass().fMass / -2.5
		...
		local addAction = vehicle:VehicleAddSlowdownAction{ fTopSpeedMultiplier = 0.5 }
	...
	-- set the surface type to SurfaceType_Mud, aka 8
    vehicle:VehicleSetSurfaceTypeOverride{iSurfaceType = 8}
...
function onOffCollisionPhantom(self, msg)
	...
	-- set the surface type to SurfaceType_Sand, aka 2
