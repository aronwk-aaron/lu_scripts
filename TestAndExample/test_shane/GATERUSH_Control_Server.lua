    ...
    local racingParams =
		{
			...
			{ "Minimum_Players_to_Start", 1 },				-- INT ( The min number of players to start game )
			{ "Minimum_Players_for_Group_Achievments", 1 },	-- INT ( the minimum number of players required to get "group" achievements )

			--- Game Object Lots ---
			{ "Car_Object", 7703 },
			{ "Race_PathName", "MainPath" },
			{ "Number_of_Gates", 9 },		   -- Number of Gates to win the race
			{ "activityID", 56 },	--@TODO: using NS Racetrack for now, change this to something valid if this thing goes further...
