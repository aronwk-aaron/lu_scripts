...
function targetSettings(self)
	...
	paths = {}
	--------------------------------------------------------------
	AddPath(paths,	"Strom_1")
    AddPath(paths,	"Strom_2")
	AddSpawn(spawn,paths,
		 4712,	0.0,	2.0,	true,	1,	2,	4,	1000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)         

    -- Ship 2
	--------------------------------------------------------------
	paths = {}
	--------------------------------------------------------------	
    AddPath(paths,	"Strom_5")
    AddPath(paths,	"Strom_6")
	AddSpawn(spawn,paths,
		 4712,	0.0,	2.0,	true,	1,	2,	4,	1000,		false,	0.0,	1.0,	1.0,	false,	    true,		0.0)
    ...
    AddPath(paths,	"Strom_2")
	AddSpawn(spawn,paths,
		 4712,	0.0,	2.0,	true,	1,	2,	5,	1000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Strom_6")
	AddSpawn(spawn,paths,
		 4712,	2.0,	4.0,	true,	1,	2,	4,	1000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)
	...
	paths = {}
	--------------------------------------------------------------
    AddPath(paths,	"Strom_3")
    AddPath(paths,	"Strom_4")
	AddSpawn(spawn,paths,
		 4712,	12.0,	15.0,	true,	1,	2,	4,	1000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)         

    -- Ship 2
	--------------------------------------------------------------
	paths = {}
	--------------------------------------------------------------	
    AddPath(paths,	"Strom_7")
    AddPath(paths,	"Strom_8")
	AddSpawn(spawn,paths,
		 4712,	12.0,	15.0,	true,	1,	2,	4,	1000,		false,	0.0,	1.0,	1.0,	false,	    true,		0.0)
	...
	paths = {}
	--------------------------------------------------------------
    AddPath(paths,	"Mech_5")
    AddPath(paths,	"Mech_6")
	AddSpawn(spawn,paths,
		 6253,	0.0,	2.0,	true,	1,	2,	3,	2000,		false,	0.0,	4.0,	1.0,	false,		true,		0.0)
    
    -- Ship 3
	--------------------------------------------------------------
	paths = {}
	--------------------------------------------------------------
	AddPath(paths,	"Mech_1")
    AddPath(paths,	"Mech_2")
	AddSpawn(spawn,paths,
		 4712,	0.0,	2.0,	true,	1,	2,	3,	1000,		false,	0.0,	4.0,	1.0,	false,		true,		0.0)
    -- 6253 4
	--------------------------------------------------------------
	paths = {}
	--------------------------------------------------------------
    ...
    AddPath(paths,	"Strom_4")
	AddSpawn(spawn,paths,
		 4712,	2.0,	4.0,	true,	1,	2,	5,	1000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)
	...
	paths = {}
	--------------------------------------------------------------
    AddPath(paths,	"Mech_3")
    AddPath(paths,	"Mech_4")
    AddSpawn(spawn,paths,
		 6253,	5.0,	10.0,	true,	1,	2,	3,	2000,		false,	0.0,	4.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Strom_2")
	AddSpawn(spawn,paths,
		 4712,	5.0,	10.0,	true,	1,	2,	5,	1000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Strom_6")
	AddSpawn(spawn,paths,
		 4712,	12.0,	15.0,	true,	1,	2,	5,	1000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Mech_2")
	AddSpawn(spawn,paths,
		 6253,	2.0,	4.0,	true,	1,	2,	3,	2000,		false,	0.0,	4.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Mech_2")
    AddSpawn(spawn,paths,
		 6253,	5.0,	10.0,	true,	1,	2,	4,	2000,		false,	0.0,	4.0,	1.0,	false,		true,		0.0)
    
    -- Ness
	--------------------------------------------------------------
	paths = {}
	--------------------------------------------------------------
	AddPath(paths,	"Spider_1")
    AddPath(paths,	"Spider_2")
	AddSpawn(spawn,paths,
		 6359,	5.0,	10.0,	true,	1,	2,	4,	3000,		false,	0.0,	4.0,	1.0,	false,		true,		0.0)
    
	-- Ship 1
	--------------------------------------------------------------
	paths = {}
	--------------------------------------------------------------
    AddPath(paths,	"Spider_3")
    AddPath(paths,	"Spider_4")
	AddSpawn(spawn,paths,
		 6359,	5.0,	10.0,	true,	1,	2,	4,	3000,		false,	0.0,	4.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Strom_6")
	AddSpawn(spawn,paths,
		 4712,	10.0,	12.0,	true,	1,	2,	5,	1000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Spider_2")
	AddSpawn(spawn,paths,
		 6359,	10.0,	12.0,	true,	1,	2,	4,	3000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Strom_8")
	AddSpawn(spawn,paths,
		 4712,	10.0,	12.0,	true,	1,	2,	5.0,	1000,		false,	0.0,	1.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Mech_4")
    AddSpawn(spawn,paths,
		 6253,	10.0,	12.0,	true,	1,	2,	4,	2000,		false,	0.0,	4.0,	1.0,	false,		true,		0.0)
    ...
    AddPath(paths,	"Mech_3")
	AddSpawn(spawn,paths,
		 6253,	12.0,	15.0,	true,	1,	2,	4,	2000,		false,	0.0,	4.0,	1.0,	false,		true,		0.0)
...
function targetEscaped(self)
    self:SetNetworkVar("targetEscaped", true)
...
function onNotifyObject(self, msg)    
    if msg.name ~= "FinishedPath" then return end
    
	checkSpawn(self, msg.ObjIDSender)
	
	if (not self:GetVar("WaveStatus")) or self:GetVar("lastEscapeID") == msg.ObjIDSender:GetID() then return end
	
	self:SetVar("lastEscapeID", msg.ObjIDSender:GetID())
	
	-- check to see if this is not a friendly and remove points from your score
	if m_totalScore <= 0 then return end
