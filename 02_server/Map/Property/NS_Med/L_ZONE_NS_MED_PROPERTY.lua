...
local Spawners = {
					Enemy 			= { "Admirals","AdmiralsWander","Mechs","Ronin","RoninWander" }, -- "MechsWander", this can be as many spawner networks as necessary, 
...
local flags = { 
				defeatedProperty 	= 122,			-- when the player builds the claim marker, this flag is set
				placedModel 		= 123,			-- when a player places a model for the first time, this flag is set
				guardMission		= 1322,			-- last mission for the guard
