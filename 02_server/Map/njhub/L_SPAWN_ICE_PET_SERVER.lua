...
--------------------------------------------------------------
local petLOT = 16479 -- lot number of the pet to be spawned
local petType = "icedragon"	-- name of the type of pet to be spawned
...
local spawnCinematic = 'IcePetSpawn'  -- name of camera path for the spawn in
--------------------------------------------------------------
