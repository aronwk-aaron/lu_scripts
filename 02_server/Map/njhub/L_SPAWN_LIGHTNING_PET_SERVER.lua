...
--------------------------------------------------------------
local petLOT = 16740 -- lot number of the pet to be spawned
local petType = "lightningdragon"	-- name of the type of pet to be spawned
...
local spawnCinematic = 'LightningPetSpawn'  -- name of camera path for the spawn in
--------------------------------------------------------------
