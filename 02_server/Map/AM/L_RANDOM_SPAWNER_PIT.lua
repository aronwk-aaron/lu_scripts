...
--	  }
	...
	{ 
		{-- ** Load 1 -------------------------- **
			{LOT = mobs.admiral, num = 4, name = "type1",},
			{LOT = mobs.spider, num = 3, name = "type2",},
			iChance = 5, -- % to spawn
		},
		{-- ** Load 2 -------------------------- **
			{LOT = mobs.admiral, num = 4, name = "type1",},
			{LOT = mobs.pirate, num = 7, name = "type2",},
			iChance = 15, -- % to spawn
		},
		{-- ** Load 3 -------------------------- **
			{LOT = mobs.spider, num = 4, name = "type1",},
			{LOT = mobs.stromb, num = 10, name = "type2",},
			iChance = 15, -- % to spawn
		},
		{-- ** Load 4 -------------------------- **
			{LOT = mobs.mech, num = 2, name = "type1",},
			{LOT = mobs.horse, num = 1, name = "type2",},
			iChance = 6, -- % to spawn
		},
		{-- ** Load 5 -------------------------- **
			{LOT = mobs.gorilla, num = 1, name = "type1",},
			{LOT = mobs.admiral, num = 4, name = "type2",},
			iChance = 2, -- % to spawn
		},
		{-- ** Load 6 -------------------------- **
			{LOT = mobs.pirate, num = 7, name = "type1",},
			{LOT = mobs.ronin, num = 6, name = "type2",},
			iChance = 5, -- % to spawn
		},
		{-- ** Load 7 -------------------------- **
			{LOT = mobs.spider, num = 3, name = "type1",},
			{LOT = mobs.ronin, num = 9, name = "type2",},
			iChance = 10, -- % to spawn
		},
		{-- ** Load 8 -------------------------- **
			{LOT = mobs.gorilla, num = 1, name = "type1",},
			{LOT = mobs.stromb, num = 8, name = "type2",},
			iChance = 2, -- % to spawn
		},
		{-- ** Load 9 -------------------------- **
			{LOT = mobs.mech, num = 2, name = "type1",},
		...
		{-- ** Load 10 -------------------------- **
			{LOT = mobs.horse, num = 2, name = "type1",},
			{LOT = mobs.admiral, num = 3, name = "type2",},
			iChance = 1, -- % to spawn
		},
		{-- ** Load 11 -------------------------- **
