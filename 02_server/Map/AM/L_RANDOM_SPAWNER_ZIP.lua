...
local sets =
	...
	{ 
		{-- ** Load 1 -------------------------- **
			...
			{LOT = mobs.spider, num = 1, name = "type4",},
			iChance = 19, -- % to spawn
		},
		{-- ** Load 2 -------------------------- **
			{LOT = mobs.spider, num = 1, name = "type1",},
			{LOT = mobs.pirate, num = 2, name = "type2",},
			{LOT = mobs.pirate, num = 1, name = "type3",},
			{LOT = mobs.admiral, num = 1, name = "type4",},
			iChance = 19, -- % to spawn
		}, 
		{-- ** Load 3 -------------------------- **
			{LOT = mobs.mech, num = 3, name = "type1",},
			{LOT = mobs.stromb, num = 1, name = "type2",},
			{LOT = mobs.pirate, num = 1, name = "type3",},
			{LOT = mobs.stromb, num = 1, name = "type4",},
			iChance = 10, -- % to spawn
		}, 
		{-- ** Load 4 -------------------------- **
			{LOT = mobs.horse, num = .75, name = "type1",},
			{LOT = mobs.stromb, num = 2, name = "type2",},
			{LOT = mobs.ronin, num = 1, name = "type3",},
			{LOT = mobs.pirate, num = 1, name = "type4",},
			iChance = 5, -- % to spawn
		},  
		{-- ** Load 5 -------------------------- **
			{LOT = mobs.gorilla, num = 1, name = "type1",},
			{LOT = mobs.admiral, num = 1, name = "type2",},
			{LOT = mobs.stromb, num = 2, name = "type3",},
			{LOT = mobs.pirate, num = 0, name = "type4",},
			iChance = 1, -- % to spawn
		},
		{-- ** Load 6 -------------------------- **
			...
			{LOT = mobs.stromb, num = 2, name = "type3",},
			{LOT = mobs.mech, num = 1, name = "type4",},
			iChance = 19, -- % to spawn
		},
		{-- ** Load 7 -------------------------- **
			{LOT = mobs.spider, num = 2, name = "type1",},
			{LOT = mobs.stromb, num = 0, name = "type2",},
			{LOT = mobs.ronin, num = 0, name = "type3",},
			{LOT = mobs.pirate, num = 0, name = "type4",},
			iChance = 1, -- % to spawn
		},
		{-- ** Load 8 -------------------------- **
		...
		{-- ** Load 9 -------------------------- **
			{LOT = mobs.spider, num = 1, name = "type1",},
			{LOT = mobs.mech, num = 2, name = "type2",},
			{LOT = mobs.stromb, num = 2, name = "type3",},
			{LOT = mobs.pirate, num = 0, name = "type4",},
			iChance = 18, -- % to spawn
		},
		{-- ** Load 10 -------------------------- **
			{LOT = mobs.horse, num = 1, name = "type1",},
			{LOT = mobs.stromb, num = 0, name = "type2",},
