...
-- local constants
local mobDeathResetNumber = 30	-- how many mobs need to die in a section before a new load is picked
	-- Do Not Change: constant for the location of the sectionID when split(spawnerName, "_") is called
local zoneName = "fin"
...
--	  }  	
	...
	{ 
		{-- ** Load 1 -------------------------- **
			{LOT = mobs.pirate, num = 3, name = "type1",},
		...
		{-- ** Load 2 -------------------------- **
			...
			{LOT = mobs.mech, num = 2, name = "type3",},
			iChance = 5, -- % to spawn
		},
		{-- ** Load 3 -------------------------- **
		...
		{-- ** Load 5 -------------------------- **
			...
			{LOT = mobs.gorilla, num = 1, name = "type3",},
			iChance = 1, -- % to spawn
		},
		{-- ** Load 6 -------------------------- **
