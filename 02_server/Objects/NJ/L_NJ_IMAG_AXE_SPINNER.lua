...
local defaultElement_type = "imagination"	-- other types; fire, earth, ice, lighting, collision, imagination
local defaultDamageHeight = -8				-- config data variable = damage_height -> 1:-4 
-- audio GUIDs
...
local audioDefaultSpinningGUID      = "{43d11dc0-a096-4595-8fbe-f95a4a0d951e}"
