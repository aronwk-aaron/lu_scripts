--------------------------------------------------------------
-- Foot Race script for SpaceShip Battle Instance 
-- updated pml... 10/13/10
-- updated 10/20/10 by ryan.schneider using VE_Foot_Race_Path_02
--------------------------------------------------------------
require('ai/ACT/L_ACT_GENERIC_ACTIVITY_MGR')
require('ai/ACT/FootRace/L_ACT_BASE_FOOT_RACE_CLIENT')

local gVars = { pathName = "VE_Foot_Race_Path_02",
                goalLot = 8575,           
                ...
                completedSetFlagNum = 117,      -- sets the specified flag when the race is completed
