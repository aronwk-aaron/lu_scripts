...
function onGetPriorityPickListType(self, msg)  
	...
	if self:GetMissionForPlayer{playerID = GAMEOBJ:GetLocalChar()}.missionState ~= 0 then return end
...
function onProximityUpdate(self, msg)
    ...
    if ( (controlled) and (controlled:Exists()) ) then
		if msg.status == "ENTER" and msg.objId:GetID() == controlled:GetID() and msg.name == "chatBubbleProx" then
