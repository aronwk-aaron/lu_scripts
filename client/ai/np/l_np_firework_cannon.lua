...
function onProximityUpdate(self, msg)
	...
	if (msg.status == "ENTER") and (msg.objId:GetID() == GAMEOBJ:GetControlledID():GetID()) then

		SetIsActive(self, true)
		SetupFireTimer(self)

	elseif (msg.status == "LEAVE") and (msg.objId:GetID() == GAMEOBJ:GetControlledID():GetID()) then
