...
local gVars = { pathName = "Foot_Race_Path_01",
                goalLot = 8575,           
                obsticleLot = {--[[8572, 8578, 8579, 6214,--]]}, --6215, 8576, 
                numOfObsticles = 2,
                finalGoalObsticleLot = 6216,
                sStopTooltipText = Localize("DOJO_FOOT_RACE_STOP_QUESTION"),
                sStartTooltipText = Localize("DOJO_FOOT_RACE_START_QUESTION"),
                sFirstGoalText = Localize("DOJO_FOOT_RACE_FIRST_GOAL"),
                sFinalGoalText = Localize("DOJO_FOOT_RACE_FINAL_GOAL"),
