...
local gVars = { pathName = "Foot_Race_Path_03",
                ...
                sStartTooltipText = Localize("PANDA_FOOT_RACE_START_QUESTION"),  --Do you want to complete the Panda race for a chance to tame a Panda?
                sFirstGoalText = Localize("PANDA_FOOT_RACE_FIRST_GOAL"),  --Nice work!  Keep going!
                sFinalGoalText = Localize("PANDA_FOOT_RACE_FINAL_GOAL"),  --You finished the race!  Now you can tame a Panda!
                startTime = 5,     -- amount of time the player should start the race with
                ...
                completedFireEventGroup = "PandaPet",} -- -ie- "PandaGroup" - calls FireEventServerSide message named Foot_Race_Completed to the group with the playerID as param1

-- these variabls are for setting up the goal posts only
local tGoalpostVars = { goalpostLot = 2164,
