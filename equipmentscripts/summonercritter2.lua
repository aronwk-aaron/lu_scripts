...
function onOnHit(self, msg)
    self:CastSkill{skillID = 644, optionalOriginatorID = self:GetVar("PlayerCaster")}

end

-- When casting a skill, ensure the player is the caster
function onCastSkill(self, msg)
    optionalOriginatorID = self:GetVar("PlayerCaster")
end
