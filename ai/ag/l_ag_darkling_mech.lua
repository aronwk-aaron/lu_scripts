...
--------------------------------------------------------------------------------
------ 
--self:SetVar("PrepTime", 10)
--setState("AiDisable",self)
--GAMEOBJ:GetTimer():AddTimerWithCancel( self:GetVar("PrepTime")  , "PrepTime", self )
...
--[[
------------------------
-- Tells the robot to turn on AI and Physics and start working
-------------------------
onTimerDone = function(self, msg)
    if msg.name == "PrepTime" then
        self:SetFaction{faction = 4}
