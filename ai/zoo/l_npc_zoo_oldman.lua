...
--]]
    ...
    Set['tetherRadius']     = 200     -- Tether  Radius
    Set['tetherSpeed']      = 8      -- Tether Speed
    Set['wanderRadius']     = 20      -- Wander Radius
    --- FOV Radius -- 
    -- Aggro
