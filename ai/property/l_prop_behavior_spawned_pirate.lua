...
--]]
    ...
    --Set['tetherRadius']     = 101     -- Tether  Radius
    Set['tetherSpeed']      = 8      -- Tether Speed
    Set['wanderRadius']     = 51      -- Wander Radius
    --- FOV Radius -- 
    -- Aggro
...
--]]
    ...
    Set['WanderDelayMin']    = 3            -- Min Wander Delay
    Set['WanderDelayMax']    = 6            -- Max Wander Delay
...
function onPhysicsComponentReady(self,msg)
	-- We shouldn't be able to push any models around on property
	local LEGO_MODEL_GROUP = 15
	self:SetZeroImpulseAgainstCollisionGroups{bApply=true, collisionGroups=LEGO_MODEL_GROUP}
end
