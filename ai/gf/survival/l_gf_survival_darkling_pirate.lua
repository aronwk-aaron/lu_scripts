...
--]]
    ...
    Set['aggroRadius']      = 180     -- Aggro Radius
...
--]] 
    ...
    Set['AggroSpeed']     = 4          -- Multiplier of the NPC's base speed to approach while attacking
...
--------------------------------------------------------------------------------
	...
	if not self:GetVar("attached_path") then
		ProximityPuls(self)
	end
...
function onDie(self, msg)
	GAMEOBJ:GetZoneControlID():NotifyObject{ name="Strombie", param1 = 100, ObjIDSender = msg.killerID}
end
