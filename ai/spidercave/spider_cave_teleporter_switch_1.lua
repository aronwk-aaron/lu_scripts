...
function onFireEvent(self, msg)
   if msg.args == "down" then
      ...
      local object = self:GetObjectsInGroup{group = "teleportSwitch2", ignoreSpawners = true}.objects[1]
      if object then
   ...
   elseif msg.args == "up" then
      self:SetVar("IAMengaged", false)
      local object2 = self:GetObjectsInGroup{group = "teleportSwitch2", ignoreSpawners = true}.objects[1]
      if object2 then
