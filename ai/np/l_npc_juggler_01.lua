...
--]]
    ...
    Set['tetherRadius']     = 70     -- Tether  Radius
    Set['tetherSpeed']      = .75      -- Tether Speed
    Set['wanderRadius']     = 30      -- Wander Radius
    --- FOV Radius -- 
    -- Aggro
...
---------------------------------------------------3-----------------------------
	...
	function onUse(self, msg)
            ...
            for i = 1, table.maxn (friends) do      
                if friends[i]:GetLOT().objtemplate == 3213 then -- Mim
                     friends[i]:NotifyObject{ name="Start22" }
                end              
            end  
	end
