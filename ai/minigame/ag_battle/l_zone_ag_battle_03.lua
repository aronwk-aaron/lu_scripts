...
-- Updated 4/13 Darren McKinsey
-----------------------------------------------------------
require('o_mis')
CONSTANTS = {}
CONSTANTS["NO_OBJECT"] = "0"

local spawnerNames = {"stromling_01","stromling_02","stromling_03","stromling_04","picnic_01","hedgehog_01","barrier_01"}
local missionNum = 810
