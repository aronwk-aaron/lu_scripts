...
--------------------------------------------------------------------------------
   ...
   self:AddObjectToGroup{group = "spiderGroup"}
   
   self:SetVar("legTrap", false)
...
function onNotifyObject(self, msg)
   ...
   if msg.name == "trapIsSet" then
      self:SetVar("legTrap", true)
   elseif msg.name == "trapDisarmed" then
      self:SetVar("legTrap", false)
...
function onArrived(self, msg)
   ...
   if (msg.wayPoint == 1) and self:GetVar("legTrap") == true then
      self:StopPathing()
      print("Awesome!" .. tostring(self:GetVar("legTrap")))
   end
