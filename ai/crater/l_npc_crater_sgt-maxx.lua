...
--]]
    ...
    Set['WanderDelayMin']    = 1
    Set['WanderDelayMax']    = 2
...
--]] 
    ...
    Set['Aggression']     = "Neutral"  -- [Aggressive]--[Neutral] 
    Set['AggroNPC']        = false
...
--]]
    ...
    Set['FearType']        = "FleeEmote"-- ['Flee'],['FleeEmote'], ['EmoteFlee']
    Set['FearDistance']    = 40        -- Flee Distance 
    Set['FearTime']        = 8         -- Time before retruning to the orginal pos. 
    Set['FearSpeed']       = 6         -- NPC walk speed
    Set['FearFace']        = false      -- NPC will face target when it has reached its flee pos. 
...
-- Action 
    ...
    Set['Con_1_AChance']    = 10          -- Chance to Play
...
-- Action 
    ...
    Set['Con_2_Type']       = "follow"    -- String name of type ['follow'],['face']
    Set['Con_2_Distance']   = 3           -- Option Distance [ follow = distance to npc ]
...
-- Emote 
    ...
    Set['Con_2_EffectType'] = "breakdance"    -- The Effect Name
    Set['Con_2_ETarget']    = true        -- Turns the NPC to the Target Before Emoting 
    Set['Con_2_EDelay']     = 3           --  Delay
    Set['Con_2_ESkill']     = true
