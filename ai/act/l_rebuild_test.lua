...
---  //////////////////////////////////////////////
    Set['EmoteEvent']       = true
    Set['Emote_EventName']  = "testRebuild"
    Set['Emote_Name']       = "wave"
    Set['Emote_EventDelay'] = 2
...
--]]
    ...
    --**********************************************************************
    Set['MovementType']     = "Patroler" --["Patroler"],["Guard"],["Wander"],[Frozen]
    --**********************************************************************
    ...
    Set['WayPointDelay']     = "all"          -- ["ends"],["all"],[nil]
    Set['WayPointDMin']      = 3
    Set['WayPointDMax']      = 4
    Set['WayPointSpeed']     = 1
