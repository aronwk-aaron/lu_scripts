...
--]]
    ...
    Set['tetherRadius']     = 20     -- Tether  Radius
    Set['tetherSpeed']      = 10      -- Tether Speed
    Set['wanderRadius']     = 3      -- Wander Radius
    --- FOV Radius -- 
    -- Aggro
...
--]]
    ...
    --**********************************************************************
    Set['MovementType']     = "Patroler" --["Patroler"],["Guard"],["Wander"]
    --**********************************************************************
    -- Patrol Settings ---------------------------------------------------- 
    Set['WayPointType']      = "once"     -- ["loop"],["linear"],["once"]
    Set['WayPointSet']       = "minigame-22"     -- ["name of way point set"]
    Set['WayPointDelay']     =  nil     -- ["ends"],["all"],[nil]
    Set['WayPointDMin']      = 0            -- Min Waypoint Delay
    Set['WayPointDMax']      = 0            -- Max Waypoint Delay
    Set['WayPointSpeed']     = 5           -- Waypoint Speed (Travle speed) 
    -- Patrol Events ------------------------------------------------------
    Set['WayPointEvent']     = true        -- Bool Active
    -- Wander Settings ----------------------------------------------------
...
--]] 
    ...
    Set['AggroSpeed']     = 7              -- Multiplier of the NPC's base speed to approach while attacking      
    ...
    -- NPC Hated List
    Set['NPCHated_1']      = 21       --Faction of a NPC 
...
-- Action 
    ...
    Set['Con_1_Type']       = "face"     -- String name of type ['Ninja'],['face']
...
-- Emote 
    ...
    Set['Con_1_EffectType'] = "interact"    -- The Effect Name
...
-- Action 
    ...
    Set['Con_2_Type']       = "face"     -- String name of type ['Ninja'],['face']
...
-- Emote 
    ...
    Set['Con_2_EffectType'] = "interact"    -- The Effect Name
