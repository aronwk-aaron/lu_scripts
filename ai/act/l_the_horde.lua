...
--]]
    ...
    Set['OverRideHealth']   = true   -- Bool Health Overide
    Set['Health']           = 8       -- Amount of health
...
--]]
    Set['aggroRadius']      = 900     -- Aggro Radius
    Set['conductRadius']    = 15     -- Conduct Radius
    Set['tetherRadius']     = 900    -- Tether  Radius
...
--]] 
    ...
    Set['AggroSpeed']     = 5              -- Multiplier of the NPC's base speed to approach while attacking      
...
--]]               
    ...
    Set['FearHPamount']    = 0          -- The amout of HP need to fear
