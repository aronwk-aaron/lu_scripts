...
{       
    ...
    spawnerNames = {'temple_one_mob_a', 'temple_one_mob_b', 'temple_one_mob_c'},         
    -- how many of each spawnerNames to spawn; spawnerNames[2] corresponds to spawnNumbers[random][2]
    spawnNumbers = { {4, 0, 1},{1, 0, 0},{4, 0, 0},{2, 0, 0},{2, 1, 0},{4, 0, 0},{3, 0, 0},{0, 2, 1},{4, 0, 0},{2, 0, 0},{3, 1, 0},{4, 0, 0},{4, 0, 0},{0, 0, 3},{4, 0, 0},{0, 0, 0}},   
