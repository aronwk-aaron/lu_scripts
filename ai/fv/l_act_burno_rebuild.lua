...
function onProximityUpdate(self, msg)
      ...
      if msg.objType == "Enemies" or msg.objType == "NPC" or msg.objType == "Rebuildables" and  msg.objId:GetFaction().faction == 1 and  self:GetVar("REBUILD_STATE") ~= "broke" and msg.status == "EXIT" and msg.name == "resetRadius" then
