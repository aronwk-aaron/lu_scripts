...
-- Spawn snake pieces
    ...
    RESMGR:LoadObject {objectTemplate = 6564, x = placeposx, y = placeposy, z = placeposz + 5, owner = self}
    RESMGR:LoadObject {objectTemplate = 6565, x = placeposx, y = placeposy, z = placeposz - 5, owner = self}
    RESMGR:LoadObject {objectTemplate = 6566, x = placeposx + 5, y = placeposy, z = placeposz, owner = self}
    RESMGR:LoadObject {objectTemplate = 6567, x = placeposx - 5, y = placeposy, z = placeposz, owner = self}
    RESMGR:LoadObject {objectTemplate = 6568, x = placeposx + 5, y = placeposy, z = placeposz - 5, owner = self}
...
--]]
    ...
    Set['wanderRadius']     = 25      -- Wander Radius
    -- Aggro
...
function onNotifyObject(self, msg)
    ...
    if msg.name == "next5" then
        self:SetFaction{faction = 4}
        self:PlayFXEffect{effectType = "medusa"}
    end
