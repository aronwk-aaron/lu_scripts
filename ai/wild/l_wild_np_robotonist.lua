...
--]]
    Set['aggroRadius']      = 10     -- Aggro Radius
    Set['conductRadius']    = 10     -- Conduct Radius
...
--]]               
    ...
    Set['FearChance']      = 100 
    Set['FearType']        = "EmoteFlee"    -- ['Flee'],['FleeEmote'], ['EmoteFlee']
    Set['FearDistance']    = 10        -- Flee Distance 
    Set['FearTime']        = 5         -- Time before retruning to the orginal pos. 
    Set['FearSpeed']       = 5         -- NPC walk speed
    Set['FearFace']        = true      -- NPC will face target when it has reached its flee pos. 
    Set['FearFOV']         = 360       -- [int/nil] FOV setting NPC must see you before Fleeing [Note: conduct FOV must be set to -true- ] 
                                       -- The conduct Radius will be nilled out if FOV is used.    

    -- optional: Use for Flee Taunt -- 
    Set['FearEmoteType']   = "scared" -- Animation Type
