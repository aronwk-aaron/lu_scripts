...
function onOnHit(self, msg)
    ...
    GAMEOBJ:GetTimer():AddTimerWithCancel( 4.5, "BeetleFlip",self )
    self:PlayAnimation{animationID = "onhit"}
    self:AddSkill{ skillID = 217 }
    self:CastSkill{ skillID = 217 }
    self:RemoveSkill{ skillID = 217 }
    self:RemoveSkill{ skillID = 134 }
