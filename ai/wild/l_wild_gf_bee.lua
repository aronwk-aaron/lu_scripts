...
--]]
    Set['aggroRadius']      = 15     -- Aggro Radius
    Set['conductRadius']    = 30     -- Conduct Radius
    Set['tetherRadius']     = 35     -- Tether  Radius
    Set['tetherSpeed']      = 2      -- Tether Speed
    Set['wanderRadius']     = 10      -- Wander Radius
    --- FOV Radius -- 
    -- Aggro
...
--]]
    ...
    --**********************************************************************
    Set['MovementType']     = "Wander" --["Patroler"],["Guard"],["Wander"]
    --**********************************************************************
    -- Patrol Settings ---------------------------------------------------- 
    Set['WayPointType']      = "linear"     -- ["loop"],["linear"],["once"]
    Set['WayPointSet']       = "wptest"     -- ["name of way point set"]
...
--]] 
    Set['Aggression']     = "Neutral"  -- [Aggressive]--[Neutral]--[Passive]-[PassiveAggres]-
    Set['AggroNPC']        = false
